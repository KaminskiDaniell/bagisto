...
return [
    ...
    */
    ...
    'after_or_equal'       => 'Pole :attribute musi być datą taką samą lub po :date.',
    ...
    'before_or_equal'      => 'Pole :attribute musi być datą przed lub taką samą :date.',

    'between'              => [
        'numeric' => 'Pole :attribute musi być pomiędzy :min a :max.',
        'file'    => 'Pole :attribute musi być pomiędzy :min a :max kilobajtów.',
        'string'  => 'Pole :attribute musi być pomiędzy :min a :max znaków.',
        'array'   => 'Pole :attribute musi być pomiędzy :min do :max elementów.',
    ],
